 ...
 * {@link SearchTransactionHeadlessFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SearchTransactionHeadlessFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SearchTransactionHeadlessFragment extends Fragment {
    ...
    public SearchTransactionHeadlessFragment() {
    ...
    public static SearchTransactionHeadlessFragment newInstance(String param1, String param2) {
        SearchTransactionHeadlessFragment fragment = new SearchTransactionHeadlessFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(searchType.equalsIgnoreCase(MAIN)) {
            startServiceWithReceiver();
        }else if(searchType.equalsIgnoreCase(DETAIL)){
            startServiceWithReceiverDetail();
        }
    }
